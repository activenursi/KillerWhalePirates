...
<body>
	<header id="header_wrap">
		<div class="inner_wrap">
			<nav class="menu">
				<h2 class="medi-title" style="color: blue">
					MEDI<span style="color: gray">:</span><span style="color: #FF0064">CAREER</span>
				</h2>
				<div class="sub-menu">
					<c:choose>
						<c:when test="${sessionScope.member.email ne null}">
							<ul class="sub_menu1">
								<li style="margin-right: 40px;">
									<a href="./jobPosting/em_list.do"">채용공고</a>
								</li>
								<li style="margin-right: 40px">
									<a href="./board/board.do">커뮤니티</a>
								</li>
								<li style="margin-right: 40px">
									<a href="./member/myPage.do?no=${member.no}">마이페이지</a>
								</li>
							</ul>
							<span class="sub-menuWrap2" style="float: right;">
								${member.name}님 <a style="color: white;" href="#"
								onclick="showLogoutModal()">로그아웃</a>
							</span>
						</c:when>
						<c:otherwise>
							<ul class="sub_menu3">
							...
							<span class="sub-menuWrap1" style="float: right;"> 
